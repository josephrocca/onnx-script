# Note: I copied helper.py from here: https://github.com/onnx/onnx/blob/f1cd4167d5ffd6e0ffbb2e9d58e8e831aeebb428/onnx/helper.py
# And I compiled this protobuf to produce the `onnxproto` that's imported below (in place of the original `onnx` import): https://github.com/onnx/onnx/blob/f1cd4167d5ffd6e0ffbb2e9d58e8e831aeebb428/onnx/onnx.in.proto
